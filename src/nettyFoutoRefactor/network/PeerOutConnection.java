...
import nettyFoutoRefactor.network.pipeline.MessageDecoder;
import nettyFoutoRefactor.network.pipeline.MessageEncoder;
import nettyFoutoRefactor.network.pipeline.OutEventExceptionHandler;
import nettyFoutoRefactor.network.pipeline.OutHandshakeHandler;
...
public class PeerOutConnection extends ChannelInitializer<SocketChannel> implements GenericFutureListener<ChannelFuture> {
    ...
    protected void initChannel(SocketChannel ch) {
        ...
        ch.pipeline().addLast("MessageSerializer", new MessageDecoder(serializers));
