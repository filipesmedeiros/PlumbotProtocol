...
public class Message {
     ...
     */
    public Message(MessageDecoder.MessageType messageType) {
    ...
    public ByteBuffer encode()
        ...
        messageBuffer.put(MessageDecoder.encodeMessageType(metadata.messageType()));
    ...
    /**
     * Simply returns this {@link Message}'s type. The possible types are defined in {@link MessageDecoder}
