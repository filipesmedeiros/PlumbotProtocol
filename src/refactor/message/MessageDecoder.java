...
/**
 * This class is responsible for storing some important, static information about the possible {@link refactor.message.Message}
 * types, and also for decoding incoming {@link refactor.message.Message}s
...
public class MessageDecoder {
    ...
    /**
     * This is the number of types of {@link refactor.message.Message}s that can be sent by nodes (and therefore,
    ...
    /**
     * This enum contains all types of {@link refactor.message.Message}s, with their respective names. Each one has a
    ...
    public enum MessageType {
         ...
         * of the network.
         * @return The code of the specified {@link refactor.message.Message} type, in the form of a byte
         */
        public byte code() {
            return (byte) ordinal();
        }
    ...
    /**
     * This method only decodes the {@link refactor.message.Message} type. This can be useful to save time when the program
     * only needs to know the type of the message, and not its content
     * @param encodedMessage All the bytes of the {@link refactor.message.Message} that needs to be decoded
     * @return The corresponding enum value of the {@link refactor.message.Message}
     * @throws NullMessageException Thrown if the passed {@link refactor.message.Message} is either null of empty
     * @throws InvalidMessageTypeException Thrown if the code of the {@link refactor.message.Message} is not one of the
    ...
    /**
     * Simple method to encode the type of the {@link refactor.message.Message}. It just calls the method defined in
     * {@link MessageType} that defines de code of each type
     * @param messageType The {@link refactor.message.Message} type whom code is needed
